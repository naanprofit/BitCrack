...
// of the target hashes.  ``scalarFragment`` contains the low
// ``offset + bits`` bits of the walk's scalar value, enabling the host
// to accumulate CRT constraints without needing the full 256-bit
// scalar.
